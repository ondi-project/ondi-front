...
import static com.ondi.android_ondi.View.MainActivity.KEY_CAMERA_FRONT_FACING;
import static com.ondi.android_ondi.View.MainActivity.KEY_CHANNEL_ARN;
import static com.ondi.android_ondi.View.MainActivity.KEY_CLIENT_ID;
import static com.ondi.android_ondi.View.MainActivity.KEY_ICE_SERVER_PASSWORD;
import static com.ondi.android_ondi.View.MainActivity.KEY_ICE_SERVER_TTL;
import static com.ondi.android_ondi.View.MainActivity.KEY_ICE_SERVER_URI;
import static com.ondi.android_ondi.View.MainActivity.KEY_ICE_SERVER_USER_NAME;
import static com.ondi.android_ondi.View.MainActivity.KEY_IS_MASTER;
import static com.ondi.android_ondi.View.MainActivity.KEY_REGION;
import static com.ondi.android_ondi.View.MainActivity.KEY_SEND_AUDIO;
import static com.ondi.android_ondi.View.MainActivity.KEY_WSS_ENDPOINT;
...
//    private String recipientClientId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        createNotificationChannel(); //API 26+
    }
...
//        }
    ...
    private void initWsConnection() {
        ...
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                mCreds = OndiApplication.getCredentialsProvider().getCredentials();
            }
        });
...
//
//                    createSdpOffer(recipientClientId);
//                }
            } else {
    ...
    private void createNotificationChannel() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            CharSequence name = "KVS WebRTC Data Channel Notification Channel";
            String description = "This channel shows all messages coming from WebRTC.";
